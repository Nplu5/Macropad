...
app = {               # REQUIRED dict, must be named 'app'
    ...
    'macros' : [      # List of button macros...
        ...
        # 1st row ----------
        (0x300030, 'Vol-', [[ConsumerControlCode.VOLUME_DECREMENT]]),
        (0x300000, 'Mute', [[ConsumerControlCode.MUTE]]),
        ...
        (0x000000, '', []),
        # 4th row ----------
        (0x303000, '<<', [[ConsumerControlCode.SCAN_PREVIOUS_TRACK]]),
        (0x003000, 'Play/Pause', [[ConsumerControlCode.PLAY_PAUSE]]),
        (0x303000, '>>', [[ConsumerControlCode.SCAN_NEXT_TRACK]]),
        # Encoder button ---
        (0x000000, '', [])
    ],
    'logo': './logos/Music.bmp'
}
